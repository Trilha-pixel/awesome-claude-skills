...
## Repository map
- `artifacts-builder/` — explain what lives here and when agents should edit it.
- `brand-guidelines/` — explain what lives here and when agents should edit it.
- `canvas-design/` — explain what lives here and when agents should edit it.
- `changelog-generator/` — explain what lives here and when agents should edit it.
- `competitive-ads-extractor/` — explain what lives here and when agents should edit it.
- `composio-skills/` — explain what lives here and when agents should edit it.
- `connect/` — explain what lives here and when agents should edit it.
- `connect-apps/` — explain what lives here and when agents should edit it.
